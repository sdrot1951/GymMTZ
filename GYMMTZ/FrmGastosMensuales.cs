...
namespace GYMMTZ
{
    public partial class FrmGastosMensuales : Form
    {
        ...
        private void ConstruirUI()
        {
            ...
            this.Text = "Registrar Nuevo Gasto Mensual";
        ...
        private void BtnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var bll = new GastosBLL();
                if (bll.RegistrarGastoMensual(txtDescripcion.Text, monto, idCat, idEmpleado))
                {
        ...
        private void FrmGastosMensuales_Load(object sender, EventArgs e)
        {
